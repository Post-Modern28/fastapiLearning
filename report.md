...
| --------------------------          | --------- | ------- | ------- | -----  | ----- | ----- | ----- |
| **BCI new**                         | MIST      | 14.7157 | 0.1902  | 100.03 | 0.072 | 0.539 | 0.274 |
| **BCI new filtered 15%**            | MIST      | 14.7899 | 0.1922  | 93.75  | 0.063 | 0.545 | 0.292 |
| **BCI new filtered 25%**            | MIST      | 14.7109 | 0.1908  | 92.17  | 0.061 | 0.539 | 0.284 |
...
| Модель                               | Датасет     | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------               | ----------- | ------- | ------- | -----  | ----- | -----  | -----   |
| **BCI new**                          | MIST good   | 17.5228 | 0.2379  | 273.85 | 0.119 | 0.484  | 0.247   |
| **BCI new filtered 15%**             | MIST good   | 17.5855 | 0.2450  | 299.49 | 0.139 | 0.493  | 0.277   |
| **BCI new filtered 25%**             | MIST good   | 17.5201 | 0.2398  | 224.40 | 0.069 | 0.478  | 0.243   |
...
| Модель                                | Датасет      | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------                | ---------    | ------- | ------- | -----  | ----- | -----  | ----- |
| **BCI new**                           | MIST norm    | 15.5266 | 0.1975  | 163.07 | 0.067 | 0.512  | 0.248 |
| **BCI new filtered 15%**              | MIST norm    | 15.6045 | 0.2029  | 156.46 | 0.062 | 0.518  | 0.263 |
| **BCI new filtered 25%**              | MIST norm    | 15.5680 | 0.2001  | 147.29 | 0.052 | 0.509  | 0.254 |
...
| Модель                              | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------              | --------- | ------- | ------- | -----  | ----- | -----  | -----   |
| **BCI new**                         | MIST comb | 15.7217 | 0.2015  | 159.10 | 0.069 | 0.509  | 0.248   |
| **BCI filtered 15%**                | MIST comb | 15.7981 | 0.2070  | 153.86 | 0.064 | 0.516  | 0.265   |
| **BCI filtered 25%**                | MIST comb | 15.7588 | 0.2040  | 141.63 | 0.052 | 0.506  | 0.253   |
