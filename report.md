...
### Общее сравнение MIST
| Модель                              | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| --------------------------          | --------- | ------- | ------- | -----  | ----- | ----- | ----- |
| **BCI 100 epochs**                         | MIST      | 14.7157 | 0.1902  | 100.03 | 0.072 | 0.539 | 0.274 |
| **BCI 100 epochs filtered 15%**            | MIST      | 14.7899 | 0.1922  | 93.75  | 0.063 | 0.545 | 0.292 |
| **BCI 100 epochs filtered 25%**            | MIST      | 14.7109 | 0.1908  | 92.17  | 0.061 | 0.539 | 0.284 |
| **BCI (epoch 65)**         | MIST      | 15.1457 | 0.2179  | 110.9 | 0.079 | 0.542 | 0.303 |
| **BCI (epoch 200)**     | MIST      | 14.8095 | 0.1934  | 87.31 | 0.055 | 0.538 | 0.257 |
| **BCI (epoch 185)**        | MIST      | 14.8940 | 0.1987  | 91.95 | 0.061 | 0.543 | 0.260 |
| **BCI (epoch 185) filtered 25%**    | MIST      | 14.8513 | 0.1892  | 83.98 | 0.051 | 0.533 | 0.270 |
| **BCI (epoch 200) filtered 25%**    | MIST      | 14.8933 | 0.1913  | 82.05 | 0.049 | 0.532 | 0.269 |
| **PPT**                    | MIST      | 14.5179 | 0.1920  | 50.44 | 0.016 | 0.539 | 0.267 |
| **NCE**                    | MIST      | 14.5415 | 0.2160  | 49.34 | 0.012 | 0.542 | 0.261 |
| **NCE filtered 15%**       | MIST      | 14.5667 | 0.2112  | 58.14 | 0.023 | 0.546 | 0.271 |
| **NCE filtered 25%**       | MIST      | 13.8467 | 0.1803  | 56.17 | 0.021 | 0.557 | 0.254 |
| **NCE 60 epochs**                     | MIST      | 14.2462 | 0.1984  | 58.42 | 0.023 | 0.539 | 0.268 |
| **NCE 60 epochs filtered 15%**        | MIST      | 14.5600 | 0.2018  | 52.61 | 0.016 | 0.554 | 0.259 |
| **NCE 60 epochs filtered 25%**        | MIST      | 14.2337 | 0.1992  | 50.80 | 0.014 | 0.537 | 0.250 |
| **PSPStain**               | MIST      | 14.3160 | 0.1983  | 46.93 | 0.012 | 0.545 | 0.252 |
| **PSPStain filtered 15%**  | MIST      | 14.3712 | 0.1939  | 46.00 | 0.010 | 0.529 | 0.251 |
| **PSPStain filtered 25%**  | MIST      | 14.2686 | 0.1808  | 48.12 | 0.009 | 0.534 | 0.264 |
| **TDKstain (epoch 27)**    | MIST      | 14.5848 | 0.1991  | 83.15 | 0.043 | 0.551 | 0.278 |
| **TDKstain**               | MIST      | 14.3019 | 0.1869  | 47.71 | 0.011 | 0.534 | 0.231 |
| **TDKstain filtered 15%**  | MIST      | 14.4668 | 0.1957  | 59.01 | 0.023 | 0.541 | 0.249 |
| **TDKstain filtered 25%**  | MIST      | 14.4132 | 0.1891  | 52.90 | 0.018 | 0.533 | 0.243 |
---
...
| Модель                               | Датасет     | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------               | ----------- | ------- | ------- | -----  | ----- | -----  | -----   |
| **BCI 100 epochs**                          | MIST good   | 17.5228 | 0.2379  | 273.85 | 0.119 | 0.484  | 0.247   |
| **BCI 100 epochs filtered 15%**             | MIST good   | 17.5855 | 0.2450  | 299.49 | 0.139 | 0.493  | 0.277   |
| **BCI 100 epochs filtered 25%**             | MIST good   | 17.5201 | 0.2398  | 224.40 | 0.069 | 0.478  | 0.243   |
| **BCI (epoch 65)**                   | MIST good   | 17.7911 | 0.2597  | 293.50 | 0.155 | 0.493  | 0.276   |
| **BCI (epoch 185)**                  | MIST good   | 17.7914 | 0.2438  | 259.70 | 0.086 | 0.477  | 0.229   |
| **BCI (epoch 185) filtered 25%**     | MIST good   | 17.9180 | 0.2497  | 267.54 | 0.094 | 0.464  | 0.226   |
| **BCI (epoch 200) filtered 25%**     | MIST good   | 17.9375 | 0.2485  | 225.61 | 0.041 | 0.463 | 0.219 |
| **PPT**                              | MIST good   | 17.4690 | 0.2534  | 200.39 | 0.012 | 0.447 | 0.229 |
| **NCE**                              | MIST good   | 17.2198 | 0.2584  | 261.42 | 0.079 | 0.462 | 0.239 |
| **NCE filtered 15%**                 | MIST good   | 17.5543 | 0.2618  | 263.96 | 0.078 | 0.457 | 0.230 |
| **NCE filtered 25%**                 | MIST good   | 15.9104 | 0.2176  | 271.18 | 0.094 | 0.486 | 0.269 |
| **NCE 60 epochs**                    | MIST good   | 16.5894 | 0.2402  | 225.17 | 0.033 | 0.447 | 0.223 |
| **NCE 60 epochs filtered 15%**       | MIST good   | 16.8797 | 0.2341  | 290.61 | 0.121 | 0.475 | 0.241 |
| **NCE 60 epochs filtered 25%**       | MIST good   | 17.035  | 0.2512  | 242.63 | 0.050 | 0.448 | 0.222 |
| **PSPStain**                         | MIST good   | 16.8576 | 0.2442  | 241.22 | 0.041 | 0.462 | 0.265 |
| **PSPStain filtered 15%**            | MIST good   | 17.5504 | 0.2490  | 190.12 | 0.003 | 0.4288 | 0.225 |
| **PSPStain filtered 25%**            | MIST good   | 17.1747 | 0.2257  | 234.83 | 0.047 | 0.448 | 0.261 |
| **TDKstain (epoch 27)**              | MIST good   | 17.6280 | 0.2526  | 249.1  | 0.084 | 0.488 | 0.279 |
| **TDKstain**                         | MIST good   | 17.8202 | 0.2649  | 183.30 | 0.005 | 0.476 | 0.218 |
| **TDKstain filtered 15%**            | MIST good   | 17.8788 | 0.2578  | 193.45 | 0.026 | 0.467 | 0.231 |
| **TDKstain filtered 25%**            | MIST good   | 18.0250 | 0.2569  | 176.38 | 0.004 | 0.446 | 0.215 |
---
...
| Модель                                | Датасет      | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------                | ---------    | ------- | ------- | -----  | ----- | -----  | ----- |
| **BCI 100 epochs**                           | MIST norm    | 15.5266 | 0.1975  | 163.07 | 0.067 | 0.512  | 0.248 |
| **BCI 100 epochs filtered 15%**              | MIST norm    | 15.6045 | 0.2029  | 156.46 | 0.062 | 0.518  | 0.263 |
| **BCI 100 epochs filtered 25%**              | MIST norm    | 15.5680 | 0.2001  | 147.29 | 0.052 | 0.509  | 0.254 |
| **BCI (epoch 65)**                    | MIST norm    | 15.9721 | 0.2253  | 175.78 | 0.084 | 0.518  | 0.287 |
| **BCI (epoch 185)**                   | MIST norm    | 15.7565 | 0.2071  | 152.66 | 0.058 | 0.517  | 0.234 |
| **BCI (epoch 185) filtered 25%**      | MIST norm    | 15.7553 | 0.1990  | 141.86 | 0.042 | 0.503  | 0.236 |
| **BCI (epoch 200) filtered 25%**      | MIST norm    | 15.7854 | 0.2005  | 140.22 | 0.042 | 0.501  | 0.234 |
| **PPT**                               | MIST norm    | 15.3937 | 0.2037  | 123.55 | 0.019 | 0.503  | 0.246 |
| **NCE**                               | MIST norm    | 15.1420 | 0.2152  | 120.16 | 0.011 | 0.503  | 0.232 |
| **NCE filtered 15%**                  | MIST norm    | 15.3759 | 0.2162  | 126.05 | 0.021 | 0.506  | 0.241 |
...
| **TDKstain**                          | MIST norm    | 15.2751 | 0.1971  | 118.94 | 0.013 | 0.505  | 0.217 |
| **TDKstain filtered 15%**             | MIST norm    | 15.5242 | 0.2051  | 130.11 | 0.024 | 0.512  | 0.230 |
| **TDKstain filtered 25%**             | MIST norm    | 15.5274 | 0.2011  | 118.16 | 0.017 | 0.503  | 0.220 |
---
...
| Модель                              | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓  | KID ↓ | LPIPS ↓| DISTS ↓ |
| ----------------------              | --------- | ------- | ------- | -----  | ----- | -----  | -----   |
| **BCI 100 epochs**                         | MIST comb | 15.7217 | 0.2015  | 159.10 | 0.069 | 0.509  | 0.248   |
| **BCI 100 epochs filtered 15%**                | MIST comb | 15.7981 | 0.2070  | 153.86 | 0.064 | 0.516  | 0.265   |
| **BCI 100 epochs filtered 25%**                | MIST comb | 15.7588 | 0.2040  | 141.63 | 0.052 | 0.506  | 0.253   |
| **BCI (epoch 65)**                  | MIST comb | 16.1500 | 0.2286  | 171.94 | 0.085 | 0.515  | 0.286   |
| **BCI (epoch 185)**                 | MIST comb | 15.9554 | 0.2107  | 146.94 | 0.057 | 0.513  | 0.234   |
| **BCI (epoch 185) filtered 25%**    | MIST comb | 15.9667 | 0.2039  | 140.15 | 0.045 | 0.499  | 0.235   |
| **BCI (epoch 200) filtered 25%**    | MIST comb | 15.9957 | 0.2052  | 135.54 | 0.041 | 0.498  | 0.233   |
| **PPT**                             | MIST comb | 15.5965 | 0.2086  | 117.94 | 0.019 | 0.498 | 0.245 |
| **NCE**                             | MIST comb | 15.3450 | 0.2194  | 118.20 | 0.015 | 0.500 | 0.233 |
| **NCE filtered 15%**                | MIST comb | 15.5888 | 0.2206  | 123.71 | 0.024 | 0.501 | 0.240 |
| **NCE filtered 25%**                | MIST comb | 14.6853 | 0.1921  | 133.25 | 0.034 | 0.516 | 0.240 |
| **NCE 60 epochs**                   | MIST comb | 15.0962 | 0.2025  | 103.36 | 0.006 | 0.492 | 0.234 |
| **NCE 60 epochs filtered 15%**      | MIST comb | 15.4618 | 0.2076  | 116.08 | 0.015 | 0.507 | 0.229 |
| **NCE 60 epochs filtered 25%**      | MIST comb | 15.2754 | 0.2118  | 110.35 | 0.011 | 0.492 | 0.222 |
| **PSPStain**                        | MIST comb | 15.4246 | 0.2090  | 109.74 | 0.009 | 0.504 | 0.243 |
| **PSPStain filtered 15%**           | MIST comb | 15.4866 | 0.2067  | 106.11 | 0.007 | 0.485 | 0.233 |
| **PSPStain filtered 25%**           | MIST comb | 15.2985 | 0.1919  | 104.93 | 0.004 | 0.492 | 0.250 |
| **TDKstain (epoch 27)**             | MIST comb | 15.7037 | 0.2138  | 142.6  | 0.046 | 0.522 | 0.261 |
| **TDKstain**                        | MIST comb | 15.5239 | 0.2037  | 112.64 | 0.011 | 0.503 | 0.217 |
| **TDKstain filtered 15%**           | MIST comb | 15.7544 | 0.2102  | 123.81 | 0.024 | 0.507 | 0.230 |
| **TDKstain filtered 25%**           | MIST comb | 15.7715 | 0.2065  | 111.88 | 0.016 | 0.498 | 0.220 |
...
| Модель                 | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓ | KID ↓ | LPIPS ↓| DISTS ↓ |
| ---------------------- | --------- | ------- | ------- | ----- | ----- | ----- | ----- |
| **PSPStain**           | MIST all  | 14.3160 | 0.1983  | 46.93 | 0.012 | 0.545 | 0.252 |
| **PSPStain**           | MIST good | 16.8576 | 0.2442  | 241.22 | 0.041| 0.462 | 0.265 |
| **PSPStain**           | MIST norm | 15.2694 | 0.2051  | 113.44 | 0.008| 0.508 | 0.240 |
| **PSPStain**           | MIST comb | 15.4246 | 0.2090  | 109.74 | 0.009| 0.504 | 0.243 |
...
| Модель                 | Датасет    | PSNR ↑    | SSIM ↑  | FID ↓ | KID ↓ | LPIPS ↓| DISTS ↓ |
| ---------------------- | ---------  | -------  | ------- | ------ | ----- | ------ | ----- |
| **NCE**                | MIST all   | 14.54    | 0.2161  | 66.01  | 0.030 | 0.535 | 0.271 |
| **NCE**                | MIST good  | 17.2198  | 0.2584  | 261.42 | 0.079 | 0.462 | 0.239 |
| **NCE**                | MIST norm  | 15.1420  | 0.2152  | 120.16 | 0.011 | 0.503 | 0.232 |
| **NCE**                | MIST comb  | 15.3450  | 0.2194  | 118.20 | 0.015 | 0.500 | 0.233 |
...
| Модель                 | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓ | KID ↓ | LPIPS ↓| DISTS ↓ |
| ---------------------- | --------- | ------- | ------- | ----- | ----- | ----- | ----- |
| **BCI (epoch 65)**     | MIST all     | 15.1457 | 0.2179  | 110.9 | 0.079 | 0.542 | 0.303 |
| **BCI (epoch 65)**     | MIST good    | 17.7911 | 0.2597  | 293.50 | 0.155 | 0.493 | 0.276 |
| **BCI (epoch 65)**     | MIST norm    | 15.9721 | 0.2253  | 175.78 | 0.084 | 0.518 | 0.287 |
| **BCI (epoch 65)**     | MIST comb    | 16.1500 | 0.2286  | 171.94 | 0.085 | 0.515 | 0.286 |
...
| Модель                 | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓ | KID ↓ | LPIPS ↓| DISTS ↓ |
| ---------------------- | --------- | ------- | ------- | ----- | ----- | ----- | ----- |
| **PPT**                | MIST  all     | 14.5179 | 0.1920  | 50.44 | 0.016  | 0.539 | 0.267 |
| **PPT**                | MIST  good    | 17.4690 | 0.2534  | 200.39 | 0.012 | 0.447 | 0.229 |
| **PPT**                | MIST  norm    | 15.3937 | 0.2037  | 123.55 | 0.019 | 0.503 | 0.246 |
| **PPT**                | MIST  comb    | 15.5965 | 0.2086  | 117.94 | 0.019 | 0.498 | 0.245 |
...
| Модель                 | Датасет   | PSNR ↑  | SSIM ↑  | FID ↓ | KID ↓ | LPIPS ↓| DISTS ↓ |
| ---------------------- | --------- | ------- | ------- | ----- | ----- | ----- | ----- |
| **TDKstain (epoch 27)**| MIST  all | 14.5848 | 0.1991  | 83.15 | 0.043  | 0.551 | 0.278 |
| **TDKstain (epoch 27)**| MIST  good | 17.6280 | 0.2526 | 249.1 | 0.084  | 0.488 | 0.279 |
| **TDKstain (epoch 27)**| MIST  norm | 15.4952 | 0.2096 | 145.8 | 0.044  | 0.526 | 0.259 |
| **TDKstain (epoch 27)**| MIST  comb | 15.7037 | 0.2138 | 142.6 | 0.046  | 0.522 | 0.261 |
---
